...
$(document).ready(function () {
    ...
    /*==============================================================*/
    /* var $buythemediv = '<div class="buy-theme alt-font md-display-none"><a href="https://themeforest.net/item/bizllence-creative-agency-corporate-and-portfolio-multipurpose-template/20645944?ref=" target="_blank"><i class="ti-shopping-cart"></i><span>Buy Theme</span></a></div><div class="all-demo alt-font md-display-none"><a href="mailto:info@.com?subject=bizllence - Creative Agency, Corporate and Portfolio Multi-purpose Template - Quick Question"><i class="ti-email"></i><span>Quick Question?</span></a></div>';
...
$("#twentyfive").click(function(){
     ...
     $("#seventyfive1").hide();
     $("#onehundred1").hide();
        $("#twentyfive1").css("display", "block");
});
$("#seventyfive").click(function(){
    $("#five1").hide();
     $("#twentyfive1").hide();
     $("#onehundred1").hide();
        $("#seventyfive1").css("display", "block");
});
$("#onehundred").click(function(){
     $("#five1").hide();
     $("#twentyfive1").hide();
     $("#seventyfive1").hide();
        $("#onehundred1").css("display", "block");
});